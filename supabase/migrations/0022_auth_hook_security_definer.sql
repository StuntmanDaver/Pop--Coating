-- 0022_auth_hook_security_definer.sql
-- Make the custom access token hook independent of supabase_auth_admin BYPASSRLS in Supabase Cloud.
-- The hook remains read-only and uses a locked search_path.

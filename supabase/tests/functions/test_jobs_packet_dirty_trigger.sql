...
INSERT INTO tenants (id, name, slug) VALUES
  ('cc000000-0000-0000-0000-000000000001'::uuid, 'Trigger Test Tenant', 'trigger-test')
...
INSERT INTO companies (id, tenant_id, name) VALUES
  ('cc004000-0000-0000-0000-000000000001'::uuid,
   'cc000000-0000-0000-0000-000000000001'::uuid, 'Trigger Test Co')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO jobs (id, tenant_id, company_id, job_name, packet_token, job_number,
  ...
  ('cc006000-0000-0000-0000-000000000001'::uuid,
...
INSERT INTO jobs (id, tenant_id, company_id, job_name, packet_token, job_number,
                  intake_status, packet_dirty) VALUES
  ('cc006000-0000-0000-0000-000000000002'::uuid,
   'cc000000-0000-0000-0000-000000000001'::uuid,
   'cc004000-0000-0000-0000-000000000001'::uuid,

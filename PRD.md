...
- Encode the QR as an authenticated scanner URL using the opaque `packet_token` (e.g., `https://app.popsindustrial.com/scan?packet=<packet_token>`), not a raw job-number URL

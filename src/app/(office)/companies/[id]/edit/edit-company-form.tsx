...
} from '../../_components/company-form-fields'
import { updateCompanyFromForm, type FormState } from './actions'
...
export function EditCompanyForm({
  ...
  const action = updateCompanyFromForm.bind(null, companyId)
  ...
  return (
    <form action={dispatch} className="space-y-8">
      ...
      <CompanyFormFields defaults={defaults} />

...
import { JobFormFields, type JobFormCompany } from '../_components/job-form-fields'
import { createJobFromForm, type FormState } from './actions'

const INITIAL: FormState = { error: null }

export function NewJobForm({ companies }: { companies: JobFormCompany[] }) {
  const [state, dispatch] = useActionState(createJobFromForm, INITIAL)
  ...
  return (
    <form action={dispatch} className="space-y-8">
      ...
      <JobFormFields companies={companies} />
